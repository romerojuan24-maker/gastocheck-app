...
async function step1_registerCompany() {
  console.log('Paso 1: Invocar POST /functions/v1/register-company...');
  ...
  if (status < 200 || status >= 300) {
    console.error('ERROR: register-company falló');
    process.exit(1);
  }
...
async function step4_verifyRLS() {
  ...
  await userClient.auth.setSession({
    ...
    refresh_token: accessToken, // simplificado para prueba
  });
