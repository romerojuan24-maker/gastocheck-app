...
NEXT_PUBLIC_SUPABASE_ANON_KEY=<REDACTADO — usar variable de entorno NEXT_PUBLIC_SUPABASE_ANON_KEY>
NEXT_PUBLIC_APP_URL=http://localhost:3000
SUPABASE_SERVICE_ROLE_KEY=<REDACTADO — usar variable de entorno SUPABASE_SERVICE_ROLE_KEY>
```
