-- ============================================================================
-- GastoCheck v1.0 MIGRACIÓN SQL COMPLETA
-- Fecha: 2026-06-27
-- INSTRUCCIONES: Copia TODO este contenido y pégalo en Supabase Studio SQL Editor
-- ============================================================================
...
-- 4. CREAR TABLA PARA ASIGNACIÓN DE CONTADOR GENERAL POR EMPRESA
-- ============================================================================
...
COMMENT ON TABLE contador_general_assignments IS 'Asignación configurable de contador general por empresa.';
...
-- ✅ FIN DE MIGRACIÓN — EJECUTADO EXITOSAMENTE
-- ============================================================================
