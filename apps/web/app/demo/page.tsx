  ...
  const UploadTab = () => (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-600">Carga tu catálogo contable desde CSV, Excel o JSON</p>
      </div>
...
5020,Gastos de Administracion,egreso,deudora`}
  ...
  // TAB: CLASIFICACIÓN
  // ============================================================================
  const ClasificacionTab = () => (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-slate-900 mb-4">📊 Clasificar Gastos por Cuenta Contable</h2>
        <p className="text-slate-600">Asigna cada comprobante a su cuenta contable correspondiente</p>
      </div>

      <div className="bg-white border border-slate-200 rounded-lg p-6">
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-slate-900 mb-2">Selecciona un comprobante</label>
            <select className="w-full px-4 py-2 border border-slate-200 rounded-lg">
              <option>Tornillos Especializados - $925.68</option>
              <option>Jesus Gerardo Delgado - $186.00</option>
              <option>MTW Materiales y Ferretería - $145.00</option>
            </select>
          </div>

          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-slate-900 mb-2">Monto: $925.68</label>
              <input type="text" disabled className="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-lg" />
            </div>
            <div>
              <label className="block text-sm font-medium text-slate-900 mb-2">RFC: ABC123456XYZ</label>
              <input type="text" disabled className="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-lg" />
            </div>
          </div>

          <div>
            <label className="block text-sm font-medium text-slate-900 mb-2">Cuenta Contable (*)</label>
          ...
          <div>
            <label className="block text-sm font-medium text-slate-900 mb-2">Deducible para ISR/IVA</label>
            <select className="w-full px-4 py-2 border border-slate-200 rounded-lg">
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
        <p className="text-sm text-amber-800">ℹ️ Clasifica todos los comprobantes antes de generar la póliza contable</p>
      </div>
    </div>
  )
  ...
  const SATTab = () => (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-600">Verifica que todos los CFDIs sean vigentes antes de contabilizar</p>
      </div>
  ...
  const ExportTab = () => (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-slate-900 mb-4">⬇️ Exportar Póliza</h2>
        <p className="text-slate-600">Genera archivo para importar en tu sistema contable</p>
      </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <p className="text-sm text-blue-800">💾 Se genera un link de descarga que expira en 7 días. No se envía por WhatsApp.</p>
      </div>
  ...
  return (
    <div className="min-h-screen bg-slate-50 p-8">
      <div className="max-w-4xl mx-auto space-y-6">
        <div>
          <h1 className="text-4xl font-bold text-slate-900">Integración Contable GastoCheck</h1>
          <p className="text-slate-600 mt-2">
            DEMO - Validación SAT, clasificación de cuentas y exportación a sistemas contables
          </p>
        </div>
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
          <p className="text-sm text-amber-900">
            ⚠️ <strong>DEMO MODE:</strong> Esta es una demostración. Para usar con datos reales, accede con tu usuario en /gastocheck/polizas
          </p>
        </div>
      </div>
    </div>
