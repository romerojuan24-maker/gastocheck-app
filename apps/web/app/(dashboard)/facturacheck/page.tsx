...
export default function FacturaCheckPage() {
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      <div className="mb-6"><h1 className="text-2xl font-black text-slate-900">📄 FacturaCheck</h1><p className="text-slate-500 text-sm mt-1">Gestión de CFDI</p>
        <div className="flex flex-wrap gap-2 mt-3">
          <a href="/facturacheck/emitir" className="px-3 py-1.5 bg-emerald-500 text-white text-sm font-semibold rounded-lg hover:bg-emerald-600">📝 Emitir CFDI (timbrado PAC)</a>
          <a href="/facturacheck/recibo" className="px-3 py-1.5 bg-white border border-slate-200 text-slate-700 text-sm font-semibold rounded-lg hover:bg-slate-50">🧾 Recibo no fiscal</a>
        </div>
      </div>
