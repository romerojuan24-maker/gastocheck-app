...
export default function FacturaCheckPage() {
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      <div className="mb-6"><h1 className="text-2xl font-black text-slate-900">📄 FacturaCheck</h1><p className="text-slate-500 text-sm mt-1">Gestión de CFDI</p><a href="/facturacheck/emitir" className="inline-block mt-2 text-sm font-semibold text-emerald-600 hover:text-emerald-800">📝 Emitir CFDI (timbrado PAC) →</a></div>
